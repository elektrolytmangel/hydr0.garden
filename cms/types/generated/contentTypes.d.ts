...
export interface ApiPlantPlant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    growMedia: Schema.Attribute.Enumeration<
      ['coco', 'perlite', 'coco_perlite', 'leca', 'soil', 'none']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    growthStage: Schema.Attribute.Enumeration<
    ...
    healthStatus: Schema.Attribute.Enumeration<
      ['alive', 'dead', 'dying', 'recovering', 'unknown']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    isCurrentLocationIndoor: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    origin: Schema.Attribute.Component<'shared.location', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
